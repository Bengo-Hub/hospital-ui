...
import { useVisits, usePatient, usePatients, useCheckInVisit } from '@/hooks/useClinical';
        ...
        <div className="p-6 space-y-4 overflow-y-auto">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Not yet registered? Use "Register new patient…" below, then open a new visit for them.
            </p>
          </div>
