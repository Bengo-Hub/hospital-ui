/**
 * Tenant API (auth-api). Used for tenant-by-slug lookup so the app can theme itself
 * (logo, primary/secondary colours) before hospital-api has any domain data at all.
