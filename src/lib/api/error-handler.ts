/**
 * Parses the structured 402 limit-reached body emitted by hospital-api (and the wider
 * platform) so the limit-reached modal can render a consistent message. Plan limits
 * (beds, staff seats, branches, etc.) are structural — overageEligible is always false,
