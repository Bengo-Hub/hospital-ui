...
/**
 * Global limit-reached modal for hospital-ui. Opened imperatively (via useLimitModal) when a
 * mutation returns 402. Hospital plan limits are structural (beds, branches, staff seats) — not
 * overage-eligible — so this routes to upgrade. Exempt users never see it.
 */
