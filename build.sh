#!/usr/bin/env bash
# =============================================================================
# Hospital UI (Codevertex Afya) Build and Deploy Script
# =============================================================================
# Usage:
#   ./build.sh                     # Build only
...
GIT_USER=${GIT_USER:-"Hospital UI Bot"}
...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://afyaapi.codevertexafrica.com"}
NEXT_PUBLIC_AUTH_URL=${NEXT_PUBLIC_AUTH_URL:-"https://sso.codevertexafrica.com"}
NEXT_PUBLIC_SSO_CLIENT_ID=${NEXT_PUBLIC_SSO_CLIENT_ID:-"hospital-ui"}
